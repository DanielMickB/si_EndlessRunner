...
public class TerrainGeneratorController : MonoBehaviour
{
    ...
    public TerrainTemplateController earlyTerrainTemplates;
    ...
    private void Start()
    {
        ...
        EarlyGenerateTerrain(lastGeneratedPositionX,earlyTerrainTemplates);
       ...
       // foreach(TerrainTemplateController terrain in earlyTerrainTemplates){
        ...
        //newGame=false;
        EarlyGenerateTerrain(lastGeneratedPositionX,earlyTerrainTemplates);
        while(lastGeneratedPositionX<GetHorizontalPositionStart()){
            GenerateTerrain(lastGeneratedPositionX);//,terrain
            lastGeneratedPositionX+=terrainTemplateWidth;
        }**/
        
    }
    private void GenerateTerrain(float posX,TerrainTemplateController forceterrain = null){//,TerrainTemplateController forceterrain = null
    ...
    private void EarlyGenerateTerrain(float posX,TerrainTemplateController early){//,TerrainTemplateController forceterrain = null
        
        GameObject newTerrain = Instantiate(early.gameObject, transform);
        newTerrain.transform.position=new Vector2(posX,0f);
        spawnedTerrain.Add(newTerrain);
